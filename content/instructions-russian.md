...
### 4.2. Синтаксические пометы

### 4.2.1. Синтаксический тип конструкции (Syntactic type of construction)
...
+ **Cl + Modifier Construction** (Клауза + Модификатор) – Конструкция содержит адвербиал, который относится ко всей клаузе: e.g. **как-то/что-то Cl** – _Что-то мне душно_.

+ **Cl/XP with parentheticals** (Клауза или Фразовая группа + вводный элемент) – Конструкция с вводным элементом, то есть с таким выражением, которое выполняет дискурсивную функцию и синтаксически не является частью клаузы: **само собой (разумеется), Cl** – _Само собой, мы придем на твой концерт_.
...
### 4.2.2. Синтаксическая функция якоря, т.е. фиксированной части конструкции (Syntactic function of anchor)
...
### 4.2.3. Синтаксическая структура якоря, т.е. фикцированной части конструкции (Syntactic structure of anchor)
...
### 4.2.4. Часть речи якоря, т.е. фиксированной части конструкции (Part of speech of anchor)
